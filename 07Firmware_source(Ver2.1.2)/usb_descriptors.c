/********************************************************************
 ...
 (the 鼎ompany・ for its PIC式 Microcontroller is intended and
...
ROM BYTE configDescriptor1[]={
    ...
    DESC_CONFIG_WORD(0x007b),   // Total length of data for this cfg
...
//　ここから下はデータ通信用
    ...
    HID_NUM_OF_DSC,         // Number of class descriptors, see usbcfg.h
    DSC_RPT,                // Report descriptor type
    HID_RPT04_SIZE,0x00,//sizeof(hid_rpt04),      // Size of the report descriptor
